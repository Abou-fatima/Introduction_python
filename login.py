...
fenetre = tk.Tk()
fenetre.geometry("500x300+400+200")  # LongueurxLargeur + positionX + positionY
...
labelMailUser = tk.Label(text="E-Mail", width=15, fg="red", font=("Arial",12))
labelMailUser.place(x=15,y=90)

EntryMailUser = tk.Entry(fenetre)
EntryMailUser.place(x=165, y=90, width=200, height=25)

labelPassWordUser = tk.Label(text="Mot de passe", width=15, fg="red", font=("Arial",12))
